...
<head>
  ...
  <title>Forgot Password | CNN Community</title>
    ...
    <div class="row g-0 min-vh-100">
      ...
      <div class="col-12 col-md-4 d-flex flex-column justify-content-center align-items-center bg-white p-4 p-md-5">
        <div class="mb-4 w-100" style="max-width:500px;">
          <div class="mb-5   w-100" style="max-width:460px; transform: scale(1.05); transform-origin: left top;">
            <div class="mb-3">
            ...
            <h3 style="font-size:24px; margin-top:15px;">Forgot Password?</h3>
            <p style="font-size:15.5px; color:#555;">Enter your email to reset your password</p>
          </div>
            <form method="POST" action="/send-otp" class="w-100">
              @csrf
              @if ($errors->any())
                <ul>
